                ...
                <div class="box">
                    ...
                    <div class="box-header with-border" style="background: #eee"> 
                        ...
                        <a class="btn btn-xs btn-info pull-left" href="<?php echo e(url('/admin/content/search-content')); ?>" style="margin-right: 5px"><i class="fa fa-search"></i> Search Content </a> 
                            ...
                            <a href="<?php echo e(url('/admin/content')); ?>" class="btn btn-danger btn-xs" style="margin-right: 5px">      
                                <i class="fa fa-undo" aria-hidden="true"></i> View All </a> 
                        <a class="btn btn-xs btn-success pull-right" href="<?php echo e(url('/admin/content/create')); ?>" style="margin-right: 5px"><i class="fa fa-plus"></i> Add Content</a>
                            </a>
                    ...
                    <div class="box-footer pull-right" style="background: #eee">
                        ...
                        <hr>
                              <a href="<?php echo e(url('/admin/content')); ?>/<?php echo e($data['content']->id); ?>/edit" class="btn btn-primary btn-xs" data-toggle="tooltip" title="Edit content"><i class="fa fa-fw fa-edit"></i>  Edit Content </a>
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-footer" style="background: #eee">
                                                ...
                                                <a href="<?php echo e(url('/admin/content')); ?>/delete/<?php echo e($data['content']->id); ?>"  class="btn btn-success"  >Confirm</a>
