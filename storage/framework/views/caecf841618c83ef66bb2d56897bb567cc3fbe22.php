                    ...
                    <div class="navbar-custom-menu">
                      ...
                      <li class="dropdown messages-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                          ...
                          <span class="label label-success"> <?php echo e($header['admin_message_count']); ?></span>
                        </a>
                        <ul class="dropdown-menu">
                          <li class="header">You have <?php echo e($header['admin_message_count']); ?> messages</li>
                          <li>
                            <!-- inner menu: contains the actual data -->
                            <ul class="menu">
                            <?php $__currentLoopData = $header['admin_message']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <li><!-- start message -->
                                <a href="<?php echo e(url('/')); ?>/admin/mailbox/read/<?php echo e($row->id); ?>">
                                  <div class="pull-left">                                     
                                    <div style="height: 30px; width: 30px; border:1px solid red;"></div>
                                  </div>
                                  <h4><?php echo e($row->sender_email); ?><small><i class="fa fa-clock-o"></i> 5 mins</small></h4>
