...
<div class="container-fluid"> 
    ...
    <div class="col-md-3">
        <span class="more_news_title">Category Name</span>
        <hr  class="more_news">
        <div class="col-md-12 border-bottom">
            <div class="more_news_left">
                <img src="images/news/child-birth.jpg" class="img-thumbnail">
            </div>
        ...
        <div class="col-md-12 border-bottom">
            <div class="more_news_left">
                <img src="images/news/london_gari_hamla.jpg" class="img-thumbnail">
            </div>
            <div class="more_news_right">
                <h4>This is a Test...</h4>
                <hr style="margin: 0px;">
