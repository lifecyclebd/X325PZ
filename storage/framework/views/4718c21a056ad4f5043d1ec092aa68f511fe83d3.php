...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" action="<?php echo e(url('/admin/updatePhoto')); ?>" method="post" enctype="multipart/form-data"> 
                    <?php echo csrf_field(); ?>

                    <?php $__currentLoopData = $data['photo']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="Text" class="form-control" value="<?php echo e($value->caption); ?>" name="caption" multiple="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="name" class="col-md-4 control-label">Short Text</label>
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" value="<?php echo e($value->sub_caption); ?> name="sub_caption" multiple="true">
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
