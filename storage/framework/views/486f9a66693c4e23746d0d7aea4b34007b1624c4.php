...
<div>
        ...
        async defer></script>   
          ...
          <h3 class="life_title">Blood Request</h3>
          <h4>Need: <span class="badge" style="background-color: red"><?php echo e($data['blood_request']->request_blood_group); ?></span> Blood..!!</h4>
          <p>If you think, you are fit and available to donate blood Please response..!! It may save a life :)</p> 
          <a class="btn-xs btn-primary" href="<?php echo e(url('/')); ?>/singlerequest/agree/<?php echo e($data['blood_request']->id); ?>">Response for Donation</a>
          <a class="btn-xs btn-danger" href="<?php echo e(url('/')); ?>/singlerequest/disagree/<?php echo e($data['blood_request']->id); ?>">Unavailable</a> 
