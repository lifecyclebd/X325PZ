                        ...
                        <div class="nav-header pull-left">
                            <ul>
                              ...
                              <li class="dropdown">
                                    ...
                                    <ul class="submenu">
                                        <li><a href="<?php echo e(url('/WhoWeAre')); ?>">Who we are</a></li>
                              ...
                              <li class="dropdown">
                                    <a href="<?php echo e(url('/')); ?>">Profile</a>
                                    <ul class="submenu">
                                        <li><a href="<?php echo e(url('/profile')); ?>">Update Profile</a></li>
                                        <li><a href="<?php echo e(url('/my-profile')); ?>">View Profile</a></li> 
                                    </ul>
                                </li>
                            </ul>
                        </div>
