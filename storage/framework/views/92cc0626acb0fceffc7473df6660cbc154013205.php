...
<div>
        ...
        async defer></script>   
          ...
          <hr>
          <p align="justify"><?php echo e($data['singlemeaasge']->message); ?></p>
          <hr>
          <a class="btn-xs btn-primary" href="<?php echo e(url('/')); ?>/singlemeaasge/agree/<?php echo e($data['singlemeaasge']->id); ?>">Response for Donation</a>
          <a class="btn-xs btn-danger" href="<?php echo e(url('/')); ?>/singlemeaasge/disagree/<?php echo e($data['singlemeaasge']->id); ?>">Unavailable</a> 
