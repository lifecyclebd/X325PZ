                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table id="example1" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $data['app_blood_request']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($row->id); ?></td>
                                    <td><?php echo e($row->request_blood); ?></td>
                                    <td><?php echo e($row->request_address); ?></td>
