                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                                <a href="{{url('/admin/write/to/doctor')}}" class="">      
                    ...
                    <div class="box-body">
                    <form class="form-horizontal" action="{{url('/admin/docror/reply/store')}}" method="post" enctype='multipart/form-data' > 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input id="name" type="text" class="form-control" value="{{$data['user']->email}}" name="email"  >
                            </div>
                        </div>
                        <div class="form-group">
