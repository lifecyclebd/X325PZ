...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" action="{{url('/admin/degree/update_degree')}}" method="post"> 
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label for="name" class="col-md-4 control-label">ABBR Name</label>
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" value="{{$data['degree']->abbr}}" name="abbr"  autofocus>
                            <input type="hidden" value="{{$data['degree']->id}}" name="id"  autofocus>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" value="{{$data['degree']->degree}}" name="degree"  autofocus>
                        </div>
                    </div>
                    <div class="form-group">
