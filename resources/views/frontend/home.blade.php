                                ...
                                <div class="col-md-4">
                                    <div style="background: #eee; padding: 5px; margin: 5px; max-height: 300px;min-height: 420px;">
                                        ...
                                        <span style="float: right; width: 100%; padding: 10px;"> 
                                            ...
                                            <p style="text-align:justify; margin-top: 10px;">{!! $row->description !!}</p>
...
<div class="video" style="    background: #313131;color: #9e9b9b; min-height: 340px;font-size: 16px;text-align: center;">
	<div class="container-fluid">
		...
		<div class="col-md-4">
			<a href="{{url('/')}}/donor-register"><img style="width:200px; height:200px;margin:0 auto" src="{{url('/')}}/public/images/be-a-donor.jpg" class="img img-responsive"></a>
			 রক্তদাতা হন  
