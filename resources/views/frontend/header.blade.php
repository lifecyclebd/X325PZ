                    ...
                    <div class="container">
                        ...
                        <div class="navbar-header">
                            <a href="blood_info.html" class="navbar-brand">
                                 <img style="width:50px; height:40px" src="{{asset('/')}}/public/frontend/images/logoo.png">
                            </a>
                        ...
                        <div class="navbar-collapse collapse" id="ftheme">
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li><a id="is_active" class="is_active " href="{{ url('/') }}">Home</a></li>
                                ...
                                <li><a  id="is_active" class="" href="{{ url('/about-us') }}">About Us</a></li>
