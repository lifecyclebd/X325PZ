...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" action="{{url('/admin/designation/update_designation')}}" method="post"> 
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label for="name" class="col-md-4 control-label">Designation Name</label>
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" value="{{ $data['designation']->name }}" name="name"  autofocus>
                            <input type="hidden"value="{{ $data['designation']->id }}" name="id">
                        </div>
                    </div>
                    <div class="form-group">
