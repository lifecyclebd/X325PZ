...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" action="{{url('/admin/hospital/hospital_update')}}" method="post" > 
                    
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label for="name" class="col-md-4 control-label">Hospital Name</label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" value="{{ $data['hospital']->hospital_name }}" name="hospital_name"  autofocus>
                            <input type="hidden"value="{{ $data['hospital']->id }}" name="id">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="number" class="form-control" value="{{ $data['hospital']->phone }}" name="phone"  autofocus>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" name="details"  autofocus>{{ $data['hospital']->details }}</textarea>
                        </div>
                    </div>
